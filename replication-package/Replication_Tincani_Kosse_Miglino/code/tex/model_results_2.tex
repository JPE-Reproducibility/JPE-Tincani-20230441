...
\input{Revision/Tables R/causal_correlational_returns_eff_pers}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.8\linewidth]{Revision/Figures R/TE_over_time_enrolled_SUA.png}
	\vspace{-0.5cm}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.6\linewidth]{Revision/Figures R/TE_effort_byrank_fe_model1.png}
	\vspace{-0.5cm}
...
\input{Revision/Tables R/TE_pre_college_outcomes_model_fit} 
...
\input{Revision/Tables R/simulated_ATEs_RE}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.8\linewidth]{Revision/Figures R/TE_over_time_enrolled_SUA_count.png}
	%\vspace{-0.4cm}
    \vspace{-0.5cm}
...
\input{Revision/Tables R/simulated_ATEs}
...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.8\linewidth]{Revision/Figures R/Counterfactual_multiple_cutoffs_avg_individual_TE.png}
 % \usepackage{caption}
 \vspace{-0.5cm}
%\captionsetup{skip=-0.4\baselineskip}
