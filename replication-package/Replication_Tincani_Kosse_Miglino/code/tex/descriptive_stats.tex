...
\includegraphics[width=\linewidth]{output/figures/histogram_simce_control_all.png}
 %[scale=0.3]
 \end{subfigure}
 \begin{subfigure}[b]{0.49\textwidth}
\includegraphics[width=\linewidth]{output/figures/histogram_simce_controltop15_all.png}
 \end{subfigure}
	\vspace{-0.5cm}
...
\input{output/tables/summary_stats_outcomes.tex} 
