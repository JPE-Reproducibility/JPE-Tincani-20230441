...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.85\linewidth]{output/figures/heterog_effects_effort_score.png}
	\vspace{-0.5cm}
...
\par 
\input{output/tables/summary_beliefs}
\par 
...
\input{output/tables/TE_pre_college_outcomes_perceived_dist_cutoff_f}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.65\linewidth]{output/figures/histogram_p_graduate_T_C.png}
	\vspace{-0.5cm}
