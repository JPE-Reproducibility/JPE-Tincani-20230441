...
\input{Revision/Tables R/in_out_flow}
...
\input{Revision/Tables R/attrition_both.tex}

\input{Revision/Tables R/leebounds_effort_achievement.tex}
...
\input{Revision/Tables R/validate_achievement_effort.tex}
\input{Revision/Tables R/tab_reduced_form_irt}
...
\input{Revision/Tables R/TE_subjective_expectations_michela}



\input{Revision/Tables R/sample_balance_within_med_exp_PSU}
...
\input{Revision/Tables R/validate_beliefs.tex}
...
The decision to sit the entrance exam is taken before observing the realization of the GPA distance from cutoff and the realization of the PSU score. It is associated with both measures of beliefs in the way we would expect, suggesting these measures contain meaningful information on students' beliefs.\par %
     ...
     \input{Revision/appendix_three_types}
