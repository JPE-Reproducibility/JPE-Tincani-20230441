...
\includegraphics[width=\linewidth]{Revision/Figures R/type_histogram_2types.png}
\caption{Two types} 
\end{subfigure}
\begin{subfigure}[b]{0.49\textwidth}
\includegraphics[width=\linewidth]{Revision/Figures R/type_histogram_3types.png}
\caption{Three types} 
\end{subfigure}
...
\input{Revision/Tables R/summary_stats_outcomes_3types} 


\input{Revision/Tables R/TE_pre_college_outcomes_3types} 



\input{Revision/Tables R/fit_TE_moments_adm_enr_per_3types}
