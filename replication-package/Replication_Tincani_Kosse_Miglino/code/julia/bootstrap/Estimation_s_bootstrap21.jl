...
# Import data
   const data=DataFrame(load(joinpath(path_processed, "initial_conditions_TC_bootstrap21.dta"))); 



## get median of selectivity conditional on admissions and treatment groups from the data
#const median_sel_P=501;
#const median_sel_R=489;
#const median_sel_R_control=476.25 ;
...
#              Initialise matrices of simulated outcomes and chocies  

# ==============================================================================
 
# ----> I moved these initialisations inside Criterion_Function.jl
# ----> If too slow, move back here and adapt Criterion_Function.jl code s.t. 
#       value from optimisation iteration "i-1" never used in iteration "i"
#//////////////////////////////////////////////////////////////////////////////////
...
const matrix_empirical_moments=DataFrame(load(joinpath(path_processed, "empirical_coefficients_rescale_bootstrap21.dta")));
...
#const vector_empirical_moments=convert.(Real,DataFrame(load("Revision/empirical_coefficients_m_VA_4.dta"))[:coefficient_value]);
#const vector_empirical_moment_variance=convert.(Real,DataFrame(load("Revision/empirical_coefficients_m_VA_4.dta"))[:coefficient_variance_value]);
...
Gradientbased=false
    ...
    using NLopt
     ...
     # write logs 
      open(joinpath(path_processed, "estimation_output_s_bootstrap21.txt"), "a") do io
      ...
      writedlm(joinpath(path_processed, "estimation_theta_s_bootstrap21.csv"), min_x, ',')
end   # do io 
