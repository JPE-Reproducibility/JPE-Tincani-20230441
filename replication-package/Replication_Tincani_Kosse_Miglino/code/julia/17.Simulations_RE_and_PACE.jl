...
# (solve for fixed point in each treated school)
...
CSV.write(joinpath(path_processed, "fixed_point_by_school_RE_value_effort.csv"), df)
...
CSV.write(joinpath(path_processed, "countREandPACE_CC_2types.csv"), df)
...
CSV.write(joinpath(path_processed, "countRE_CC_cutoffs.csv"), df_cutoff)
